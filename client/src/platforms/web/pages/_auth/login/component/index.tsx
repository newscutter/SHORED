...
export default class Login extends Component<LoginProps, LoginState> {
  state: LoginState = {
    seed_phrase:
      "cogs awakened pylons cuffs tuesday musical anybody coal calamity wiring erosion bemused soccer rural onto remedy ocean cider oozed ostrich does jogger launching lower remedy",
    error: "",
    fileName: "",
        ...
        >
          {selectSeed ? (
            <>
              {/* @ts-ignore */}
              <Seed
                placeholder="Your 25 word password..."
                name="seed_phrase"
                value={seed_phrase}
                error={error}
